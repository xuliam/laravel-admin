...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ asset(__ADMIN__)}}/vendors/mdi/css/materialdesignicons.min.css">
...
<div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset(__ADMIN__)}}/images/logo.svg" alt="logo" /></a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset(__ADMIN__)}}/images/faces/face1.jpg" class="mr-2" alt="image"> David Grey </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset(__ADMIN__)}}/images/faces/face2.jpg" class="mr-2" alt="image"> Stella Johnson </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset(__ADMIN__)}}/images/faces/face3.jpg" class="mr-2" alt="image"> Marina Michel </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset(__ADMIN__)}}/images/faces/face4.jpg" class="mr-2" alt="image"> John Doe </td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col-6 pr-1">
                                        <img src="{{ asset(__ADMIN__)}}/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                                        <img src="{{ asset(__ADMIN__)}}/images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
                                    </div>
                                    <div class="col-6 pl-1">
                                        <img src="{{ asset(__ADMIN__)}}/images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                                        <img src="{{ asset(__ADMIN__)}}/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
                                    </div>
                                </div>
                                <div class="d-flex mt-5 align-items-top">
                                    <img src="{{ asset(__ADMIN__)}}/images/faces/face3.jpg" class="img-sm rounded-circle mr-3" alt="image">
...
<script src="{{ asset(__ADMIN__)}}/vendors/chart.js/Chart.min.js"></script>
<!-- End plugin js for this page -->
<!-- inject:js -->
<script src="{{ asset(__ADMIN__)}}/js/off-canvas.js"></script>
<script src="{{ asset(__ADMIN__)}}/js/hoverable-collapse.js"></script>
<script src="{{ asset(__ADMIN__)}}/js/misc.js"></script>
<!-- endinject -->
<!-- Custom js for this page -->
<script src="{{ asset(__ADMIN__)}}/js/dashboard.js"></script>
<script src="{{ asset(__ADMIN__)}}/js/todolist.js"></script>
